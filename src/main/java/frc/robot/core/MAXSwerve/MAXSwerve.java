...
public abstract class MAXSwerve extends SubsystemBase {
    ...
    private final SlewRateLimiter magLimiter = new SlewRateLimiter(MaxSwerveConstants.kMagnitudeSlewRate);
    private final SlewRateLimiter rotLimiter = new SlewRateLimiter(MaxSwerveConstants.kRotationalSlewRate);
    private double m_prevTime = WPIUtilJNI.now() * 1e-6;
    private final MAXSwerveModule fl;
    private final MAXSwerveModule fr;
    private final MAXSwerveModule bl;
    private final MAXSwerveModule br;
    private Object gyro;
    private final ShuffleboardTab tab = Shuffleboard.getTab("Drivetrain Debugging");
    ...
    private final double targetAngleTelemetry = 0;
    private final boolean isSlowModeEnabled = false;
