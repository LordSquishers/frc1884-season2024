...
public class FlywheelLookupTable {
    ...
    private final InterpolatingDoubleTreeMap distanceToFlywheelVelocity;
    private final InterpolatingDoubleTreeMap distanceToAngleSetpoint;
    private final InterpolatingDoubleTreeMap distanceToFeederVelocity;
